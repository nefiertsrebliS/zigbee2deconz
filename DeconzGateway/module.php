...
#-------------------------------------------------------------------------------------
		...
		$wsPort	= $this->ReadAttributeInteger("wsPort");
...
######################################################################################
    ...
    private function SendToDeconz($json)
    {
		...
		$this->SendDebug("SendToDeconz-Response",json_encode($JSON['Buffer']),0);
        $Data = json_encode($JSON);
        $this->SendDataToChildren($Data);
    }
